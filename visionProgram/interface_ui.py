...
"")
        ...
        sizePolicy3.setHeightForWidth(self.selectModelBtn.sizePolicy().hasHeightForWidth())
        self.selectModelBtn.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.modelFileLine.sizePolicy().hasHeightForWidth())
        self.modelFileLine.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.fetureFileLine.sizePolicy().hasHeightForWidth())
        self.fetureFileLine.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.selectFeatureBtn.sizePolicy().hasHeightForWidth())
        self.selectFeatureBtn.setSizePolicy(sizePolicy3)
        ...
        sizePolicy5.setHeightForWidth(self.autoTabBtn.sizePolicy().hasHeightForWidth())
        self.autoTabBtn.setSizePolicy(sizePolicy5)
